...
LAYOUT_LABELS = {
    ...
    "venus_ss_aprmay_positional": "VENUS KLM Stock and Sales report — sparse Apr/May movement block (positional)",
    ...
    "prompt_stock_mfr_value": "Prompt ERP Stock (Mfr + Value columns)",
    "suntraders_stock_n_sales_status": "SUN TRADERS Stock N Sales Status (Op/In/Out/Cl)",
    ...
    "subrahmanya_stock_recd_issued": "KLM Stock & Sales Statement (Item/Pack/Opening/Received/Issued/Closing stock, positional x1-binned, SRI SUBRAHMANYA)",
