...
LAYOUT_LABELS = {
    ...
    "klm_item_party_sales_statement": "KLM MARG Item/Party-wise Sales Statement (single-column text)",
    "r15_ascent_warehouse_customer_sale_dump": "ASCENT WELLNESS warehouse/customer raw sale dump (header-keyed)",
    "r15_klm_party_product_wise_sales_xlsx": "KLM Party + Product Wise Sales (XLSX, 2-level banded, DUTT)",
    "mfg_product_customer_wise_pcode": "Mfg-Products Customer Wise (PCode Band)",
    "r15_customer_product_wise_sales_swil": "Customer-Product Wise Sales (SwilERP banded, M.G. DISTRIBUTORS)",
    "sales_detail_mf_customer_itemwise": "Sales Detail Register (Mf-Customer-Itemwise, batchwise, MARUTI)",
    "r15_customer_product_analysis_split_batchtail": "Customer & Product Analysis (split-cell header, Batch-trailing, PADMALAYA)",
    "company_customer_monthwise_sales": "Company/Customer/Item Monthwise Sales Register (qty, PARAS)",
    "klm_party_product_wise_sales": "KLM Party + Product Wise Sales (3-level Area-banded, PAARTH)",
    "r15_area_customer_company_product_sales": "Area Wise Customer, Company And Product Sales (KLM banded, PURUSHOTHAM)",
    "r15_company_product_wise_sales_custband": "Company Product Wise Sales (flat bill-detail, CUST NAME bands, R K PHARMA)",
    "product_customer_sale_dc_summary": "Product-wise Customer-wise Sale/DC Summary (MediVision, RAJ DISTRIBUTORS)",
